...
# Remove any mech codes with keyword flags from HRH dataset
simple_hrhdata <- simple_hrhdata %>%
...
## 23. Writing this combined dataset to Excel 
write_xlsx(finalMerge,"./4. Outputs/HRH_ER_merged_21_22.xlsx") 
