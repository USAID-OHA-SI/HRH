...
```{r fig5, fig.height = 5, fig.width = 8, echo = FALSE, eval = TRUE}
...
# NEXT STEPS: To wrap the x-label employment titles more, to show median values, re-label the x-axis, show the dots

# Box plot with dot plot
#boxplot2 + geom_dotplot(binaxis='equivalent_annual_salary', stackdir='center', dotsize=1)
