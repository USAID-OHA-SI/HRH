...
g1 <- ggplot(data = patchwork, mapping = aes(x = reorder(beneficiary_wrapped, -actual_annual_spend), y = individual_count, fill = beneficiary_wrapped)) +
    ...
    scale_fill_manual(values = c("Priority Pops" = "#c43d4d", 
                              "Key Pops" = "#e07653", 
                              "Males" = "#2057a7",
                              "OVC" = "#1e87a5",
                              "Females" = "#f2bc40",
                              "Pregnant & Breastfeeding Women" = "#8980cb",
                              "Non-Targeted Pop" = "#287c6f",
                              "Not Specified" = "#808080")) +
...
# Now make the plot
  ...
  geom_label_repel(data = prime_partners, aes(label = scales::comma(round(individual_count))),
             size = 4,
             label.size = NA,
             position = position_stack(vjust = 0.5),
             box.padding = 0,
